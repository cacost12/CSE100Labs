...
// FUNCTION PROTOTYPES
//
// Write prototypes for any function which is defined below the location in this source
// code file from where the function is first called.
//----------------------------------------------------------------------------------------
???
...
// menu()
//
// This function is called from run() to display the menu for the program. The user will
// select one of these menu items to perform. Note that get_int_in() will not return until
// the user enters an integer in [1, 4] so it is guaranteed that the returned value will
// be a valid choice.
//
// PSEUDOCODE
// function menu() -> int
...
//     return what call get_int_in("Your Choice 1-4]? ", MENU_FIRST, MENU_LAST) returns
// end function
//----------------------------------------------------------------------------------------
static int menu()
{
    // Implement the pseudocode to implement the Prelab Exercises Menu as shown on p. 4
    // of the lab document.
    ???
}
...
// vary_for1()
//
// See the Prelab Exercises section of the project document for the software requirements.
//
// PSEUDOCODE
// function vary_for1()
//     output '['
...
//
// REMARKS
// Note that in this loop, every integer is followed by one space including the last
// integer.
//----------------------------------------------------------------------------------------
...
//
// REMARKS
// Note that in this loop, every integer is followed by one space except for the last
// integer, which is not followed by a space.
//----------------------------------------------------------------------------------------
...
// run_prelab()
//
// This function implements a sentinel loop which will repeatedly display the menu, get
// the user's choice, call the appropriate looping function, and then the sentinel loop
// repeats.
//
// PSEUDOCODE
